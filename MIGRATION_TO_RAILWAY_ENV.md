...
### 5. Настроена сборка UI пакета
- Добавлена автоматическая сборка `@questai/ui` перед установкой зависимостей
- Обновлены nixpacks.toml для обоих сервисов
- Решена проблема с ошибкой "ERR_PNPM_FETCH_404 @questai/ui"
