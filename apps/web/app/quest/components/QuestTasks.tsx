      ...
      <CardContent className="pt-2">
        <div className="space-y-4">
          {tasks.map((task, index) => (
            ...
            >
              <div className={`flex-shrink-0 w-6 h-6 rounded-full ${task.completed ? 'bg-green-100 dark:bg-green-900/70' : 'bg-gray-200 dark:bg-gray-700'} flex items-center justify-center mr-3 mt-0.5`}>
                {task.completed ? (
